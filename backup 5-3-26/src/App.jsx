...
<div className="score-subtext">
  Optimized for Etsy search
            ...
            <div className="score-subtext">{result.scoreLabel || "AI estimate"}</div>
          </div>
        </div>
        ...
        {result.scoreBreakdown && (
          <div className="score-details">
            ...
            <br></br>
            Optimized for Etsy search and buyer intent
                      </div>
        )}
  ...
  return (
    <div className="page">
      <header className="hero">
        <div className="badge">Trusted by Etsy sellers</div>
        <h1>Your title is losing you sales</h1>
        <p>
        Paste your Etsy title below — we’ll show you exactly what’s wrong and generate a higher-converting version.
        </p>
      </header>
      ...
      <main className="grid">
        <section className="card input-card">
          ...
          <button onClick={fixTitle} disabled={loading || !title.trim()}>
            {loading ? "Fixing Listing..." : "Fix My Title"}
          </button>

          <strong><p className="meta-row">Free • Takes 10 seconds • No signup required • Instant results</p></strong>
          ...
          {!result ? (
            ...
            <>
              <div className="result-header">
                <div>
                  <p className="eyebrow">Optimized for Etsy search and buyer intent</p>
              ...
              {result.missedOpportunities?.length > 0 && (
                <div className="opportunity-box premium">
                  ...
                  <p className="opportunity-sub">
                    These keywords can increase visibility and sales potential.
                  </p>
              ...
              {result.quickWins?.length > 0 && (
                <div className="quickwins-box">
                  <h3>📈 Title Optimization Insights</h3>
